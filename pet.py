                ...
                def petdetails():
                    ...
                    def service():
                        ...
                        def vetcaredetails():
                            ...
                            l = Label(root, text='Select Service Required : ', font='Times 20 bold')
                            l.grid(row=2, column=0)
                        ...
                        def pethoteldetails():
                            ...
                            Button(root, text='book pet hotel', command=showdetails, width=25,font=("Times New", 10), bd=5, bg="light grey").grid(row=8, column=1,sticky=N + S + E + W)
